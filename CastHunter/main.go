			...
			if Caster.IPS != nil {
				for i := 0; i < len(Caster.IPS); i++ {
					...
					if Caster.CheckLen() {
						...
						mac = "Could not be determined | Length issue in array (PANIC)"
					}
					if mac == "Roku, Inc" {
		...
		Atom4.Store(func() {
			...
			if Caster.IPS != nil {
				for i := 0; i < len(Caster.IPS); i++ {
					...
					if mac == "Could not be determined | Length issue in array (PANIC)" || mac == "Raspberry Pi Trading Ltd" {
						Doc += "<th>" + Caster.IPS[i] + "</th>"
						Doc += "<th>" + Caster.MACS[i] + "</th>"
						Doc += "<th>" + mac + "</th>"
						Doc += "</tr>"
		...
		Atom5.Store(func() {
			...
			if Caster.IPS != nil {
				for i := 0; i < len(Caster.IPS); i++ {
					...
					if mac == "Could not be determined | Length issue in array (PANIC)" || mac == "Apple, Inc." {
						Doc += "<th>" + Caster.IPS[i] + "</th>"
						Doc += "<th>" + Caster.MACS[i] + "</th>"
						Doc += "<th>" + mac + "</th>"
						Doc += "</tr>"
		...
		Atom6.Store(func() {
			...
			if Caster.IPS != nil {
				for i := 0; i < len(Caster.IPS); i++ {
					...
					if mac == "Could not be determined | Length issue in array (PANIC)" || mac == "Amazon Technologies Inc." {
						Doc += "<th>" + Caster.IPS[i] + "</th>"
						Doc += "<th>" + Caster.MACS[i] + "</th>"
						Doc += "<th>" + mac + "</th>"
						Doc += "</tr>"
		...
		Atom7.Store(func() {
			...
			if Caster.IPS != nil {
				for i := 0; i < len(Caster.IPS); i++ {
					...
					if mac == "Could not be determined | Length issue in array (PANIC)" || mac == "ARRIS Group, Inc." {
						Doc += "<th>" + Caster.IPS[i] + "</th>"
						Doc += "<th>" + Caster.MACS[i] + "</th>"
						Doc += "<th>" + mac + "</th>"
						Doc += "</tr>"
